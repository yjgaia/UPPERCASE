...
page.open('http://localhost:' + system.args[1] + '/' + encodeURIComponent(system.args[2] === undefined ? '' : (system.args[2][0] === '/' ? system.args[2].substring(1) : system.args[2])), function(status) {
	'use strict';
