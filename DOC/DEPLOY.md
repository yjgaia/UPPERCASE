...
5. 프로젝트 실행에 문제가 없으면 `Ctrl + C`를 눌러 프로젝트를 종료하고, `pm2` 등으로 프로젝트를 데몬 형태로 실행합니다.
```
pm2 start {{프로젝트 명.js}}
```
...
## 서버 이전하기
1. 기존 프로젝트를 중단합니다. 만약 `pm2`를 사용한다면 다음과 같이 입력합니다.
```
cd {{프로젝트 폴더 명}}
pm2 start {{프로젝트 명.js}}
```
...
8. 프로젝트를 실행합니다. 만약 `pm2`를 사용한다면 다음과 같이 입력합니다.
```
cd {{프로젝트 폴더 명}}
pm2 start {{프로젝트 명.js}}
```
